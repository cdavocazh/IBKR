...
RISK_PER_TRADE = 5_000             # Reduced for 40+ trade regime (research mode)
ES_POINT_VALUE = 50
...
BEAR_RISK_MULT = 0.4              # Very conservative short sizing
...
COOLDOWN_BARS = 96                # Reduced for 40+ trade research mode
